...
<root>
  ...
  ├── Editor
  │   ├── Meazza.ComKcBinder.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Meazza.ComKcBinder.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Meazza.ComKcBinder.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Meazza.ComKcBinder.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Meazza.ComKcBinder`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package com.kc.binder Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Meazza.ComKcBinder.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Meazza.ComKcBinder.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Meazza.ComKcBinder.Editor.Tests.asmdef`

  `Tests/Runtime/Meazza.ComKcBinder.Tests.asmdef`
...
Use the `Documentations~/com.kc.binder.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
